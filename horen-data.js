const alleHoerenPruefungen = [
    {
        ...
        teile: [
            ...
            {
                teilName: "Teil 2: Der Experten-Vortrag (Umgang mit dem Scheitern)",
            ...
            },
           {
                ...
                fragen: [
                    { frage: "22. Die soziale Isolierung im Homeoffice schadet der Identifikation mit dem Betrieb.", antworten: ["Frau Weber", "Dr. Schmidt", "Frau Lange"], richtig: 1, begruendung: "Dr. Schmidt: 'Diese soziale Vereinsamung führt dazu, dass Mitarbeiter viel schneller kündigen...'" },
                    ...
                    { frage: "24. Die Wahl des Arbeitsorts ist heute ein entscheidender Faktor im Recruiting.", antworten: ["Frau Weber", "Dr. Schmidt", "Frau Lange"], richtig: 2, begruendung: "Frau Lange: 'Die Flexibilität... ist mittlerweile das schlagkräftigste Argument in unseren Bewerbungsgesprächen.'" },
                    ...
                    { frage: "26. Die häusliche Umgebung bietet oft keine professionellen Arbeitsbedingungen.", antworten: ["Frau Weber", "Dr. Schmidt", "Frau Lange"], richtig: 1, begruendung: "Dr. Schmidt: 'Zudem darf man die prekäre Ergonomie in vielen Privathaushalten nicht vergessen...'" },
                    { frage: "27. Nur ein hybrides Modell wird den unterschiedlichen Bedürfnissen gerecht.", antworten: ["Frau Weber", "Dr. Schmidt", "Frau Lange"], richtig: 2, begruendung: "Frau Lange: 'Ein hybrides Modell... ist der einzige Weg, der beide Seiten zufriedenstellt.'" },
            ...
            },
            {
                ...
                fragen: [
                    { frage: "31. Was ist die Kernaussage von Prof. Veith zu Beginn seines Vortrags?", antworten: ["A. Informationen sind das kostbarste Gut.", "B. In einer Welt des Informationsüberflusses ist menschliche Aufmerksamkeit die knappste Ressource.", "C. Schnelleres Lernen."], richtig: 1, begruendung: "Vortrag: 'In unserer voll vernetzten Welt ist es die menschliche Aufmerksamkeit.'" },
                    ...
                    { frage: "33. Welchen Einfluss hat die „Aufmerksamkeitsökonomie“ auf den Journalismus?", antworten: ["A. Nachrichten werden kürzer und oberflächlicher, um die Klickzahlen zu erhöhen.", "B. Tiefgründige Recherchen.", "C. Höhere Qualität."], richtig: 0, begruendung: "Vortrag: 'Eine komplexe Analyse verkauft sich schlechter als eine reißerische Schlagzeile.'" },
                    { frage: "34. Was versteht der Redner unter dem Begriff „Infinite Scrolling“?", antworten: ["A. Archivierungsmethode.", "B. Ein technisches Design, das das natürliche Ende einer Informationseinheit verhindert.", "C. Lesehilfe."], richtig: 1, begruendung: "Vortrag: '...gibt es heute keinen natürlichen Stopp-Moment mehr.'" },
            ...
            },
            {
                ...
                fragen: [
                    { frage: "41. Welches Paradoxon beschreibt Prof. von Hagens zu Beginn?", antworten: ["A. Menschen konsumieren weniger.", "B. Wachstum steigt, Lebenszufriedenheit stagniert.", "C. Dass technische Innovationen den Ressourcenverbrauch nicht senken, sondern steigern."], richtig: 2, begruendung: "Prof. von Hagens: 'Das Paradoxon... ist der Rebound-Effekt... am Ende ist der absolute Ressourcenverbrauch höher als zuvor.'" },
